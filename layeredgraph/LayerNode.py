...
class LayerNode:
    ...
    def is_same_layer(self, target_layer_node: Self) -> bool:
        if self._layer == target_layer_node.get_layer():
            return True
        else:
            return False
        
    def is_same_node(self, target_layer_node: Self) -> bool:
        if self._ip == target_layer_node.get_ip():
            return True
        else:
            return False
        
    def is_same_layer_node(self, target_layer_node: Self) -> bool:
